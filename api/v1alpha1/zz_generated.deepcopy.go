...
func (in *DBaaSProviderSpec) DeepCopyInto(out *DBaaSProviderSpec) {
	*out = *in
	...
	if in.ProvisioningParametersSpec != nil {
		in, out := &in.ProvisioningParametersSpec, &out.ProvisioningParametersSpec
		*out = new(ProvisioningParametersSpec)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *ProvisioningParameter) DeepCopyInto(out *ProvisioningParameter) {
	*out = *in
	if in.OptionsLists != nil {
		in, out := &in.OptionsLists, &out.OptionsLists
		*out = make([]ProvisioningParameterOptions, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProvisioningParameterOptions) DeepCopyInto(out *ProvisioningParameterOptions) {
	*out = *in
	...
	out.DefaultOption = in.DefaultOption
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProvisioningParameterOptions.
func (in *ProvisioningParameterOptions) DeepCopy() *ProvisioningParameterOptions {
	if in == nil {
		return nil
	}
	out := new(ProvisioningParameterOptions)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProvisioningParametersSpec) DeepCopyInto(out *ProvisioningParametersSpec) {
	*out = *in
	if in.Name != nil {
	...
	if in.TeamProject != nil {
		in, out := &in.TeamProject, &out.TeamProject
		*out = new(ProvisioningParameter)
		(*in).DeepCopyInto(*out)
	}
	if in.LocationLabel != nil {
		in, out := &in.LocationLabel, &out.LocationLabel
		*out = new(ProvisioningParameter)
		(*in).DeepCopyInto(*out)
	}
	if in.HardwareLabel != nil {
		in, out := &in.HardwareLabel, &out.HardwareLabel
		*out = new(ProvisioningParameter)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProvisioningParametersSpec.
func (in *ProvisioningParametersSpec) DeepCopy() *ProvisioningParametersSpec {
	if in == nil {
		return nil
	}
	out := new(ProvisioningParametersSpec)
