...
func (r *DBaaSPlatformReconciler) enableMetricsExporter() error {
	...
	_, err = CreateOrUpdateServiceMonitor(r)
	if err != nil {
		return err
	}
	return nil
...
func getMetricsExporterService() *corev1.Service {
...
func CreateOrUpdateService(r *DBaaSPlatformReconciler) (*corev1.Service, error) {
	service := getMetricsExporterService()
...
func getMetricsExporterServiceMonitor() *monitoringv1.ServiceMonitor {
	// To add storagecluster CR name to the metrics as label: managedBy
	relabelConfig := monitoringv1.RelabelConfig{
		TargetLabel: "managedBy",
		Replacement: "dbaas-metrics-exporter",
	}
	...
	serviceMonitor := &monitoringv1.ServiceMonitor{
		...
		Spec: monitoringv1.ServiceMonitorSpec{
			NamespaceSelector: monitoringv1.NamespaceSelector{
				MatchNames: []string{"openshift-dbaas-operator"},
			},
...
func CreateOrUpdateServiceMonitor(r *DBaaSPlatformReconciler) (*monitoringv1.ServiceMonitor, error) {
	serviceMonitor := getMetricsExporterServiceMonitor()
