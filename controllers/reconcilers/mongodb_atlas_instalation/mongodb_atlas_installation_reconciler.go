...
func (r *Reconciler) Reconcile(ctx context.Context, cr *v1.DBaaSPlatform, status2 *v1.DBaaSPlatformStatus) (v1.PlatformsInstlnStatus, error) {
	...
	status, err = r.waitForMongoDBAtlasCSV(cr, ctx)
...
func (r *Reconciler) waitForMongoDBAtlasCSV(cr *v1.DBaaSPlatform, ctx context.Context) (v1.PlatformsInstlnStatus, error) {
	csv := r.getMongoDBAtlasCSV(cr)
...
func (r *Reconciler) getMongoDBAtlasCSV(cr *v1.DBaaSPlatform) *v1alpha1.ClusterServiceVersion {
	return &v1alpha1.ClusterServiceVersion{
		ObjectMeta: apimv1.ObjectMeta{
			Name:      reconcilers.MONGODB_ATLAS_CSV,
			Namespace: cr.Namespace,
		},
	}
}
