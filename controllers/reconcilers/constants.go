...
const (
	...
	// CRUNCHY_BRIDGE
	CRUNCHY_BRIDGE_CATALOG_ENV_VAR = "RELATED_IMAGE_CRUNCHY_BRIDGE_CATALOG"
	...
	// MONGODB_ATLAS
	MONGODB_ATLAS_CATALOG_ENV_VAR = "RELATED_IMAGE_MONGODB_ATLAS_CATALOG"
	...
	COCKROACHDB_CATALOG_ENV_VAR = "RELATED_IMAGE_COCKROACHDB_CATALOG"
	...
	CONSOLE_TELEMETRY_PLUGIN_ENV_VAR         = "RELATED_IMAGE_CONSOLE_TELEMETRY_PLUGIN"
	...
	RDS_PROVIDER_CATALOG_ENV_VAR = "RELATED_IMAGE_RDS_PROVIDER_CATALOG"
...
var InstallationPlatforms = map[dbaasv1alpha1.PlatformsName]dbaasv1alpha1.PlatformConfig{
	...
	dbaasv1alpha1.ConsoleTelemetryPluginInstallation: {
		...
		Image:       os.Getenv(CONSOLE_TELEMETRY_PLUGIN_ENV_VAR),
	...
	dbaasv1alpha1.CrunchyBridgeInstallation: {
		...
		Image:          os.Getenv(CRUNCHY_BRIDGE_CATALOG_ENV_VAR),
	...
	dbaasv1alpha1.MongoDBAtlasInstallation: {
		...
		Image:          os.Getenv(MONGODB_ATLAS_CATALOG_ENV_VAR),
	...
	dbaasv1alpha1.CockroachDBInstallation: {
		...
		Image:          os.Getenv(COCKROACHDB_CATALOG_ENV_VAR),
	...
	dbaasv1alpha1.RDSProviderInstallation: {
		...
		Image:          os.Getenv(RDS_PROVIDER_CATALOG_ENV_VAR),
