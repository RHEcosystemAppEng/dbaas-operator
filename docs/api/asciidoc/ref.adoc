...
| *`policy`* __xref:{anchor_prefix}-github-com-rhecosystemappeng-dbaas-operator-api-v1beta1-dbaaspolicyspec[$$DBaaSPolicySpec$$]__ | The policy for this inventory. Per inventory, completely overrides any other DBaaSPolicy settings in this namespace.
|===
